...
- **Mutation class:** `docs_only` | `product_settings` | `fs_mutation`
...
- **STAGE:** (e.g. prompt-betterment | research → plan → same-run implement if docs_only/product_settings ready)
