...
- **Program / roadmap:** `program/ROADMAP.md` + dashboard refinement plan
- **Cycle id:** Cycle 22 — dashboard items **20 + 22** (L-both)
- **ROADMAP row locked:** Multi-experiment WorkSpace only **untouched** this cycle
- **Mutation class:** `catalogue_product` (org-repo catalogue code+data)
- **Batch approval:** **approved** — **yes + L-both**. Raw includes standing amendment: after this cycle dashboard workstream done for now; next FAW must rotate / research-justify against ROADMAP (not inherit dashboard topic).
...
- [x] 0. Session bootstrap (adopted `2026.09.15-1340`)
- [x] 1. prompt-betterment → 01-prompt-betterment/ (Choose Q1–Q6 all A)
- [x] 2. researcher → 02-research/ (dashboard 20+22; skip 21)
...
| --- | --- | --- | --- |
| 01 | done | Choose all A; research picks advance; plan gate required | `01-prompt-betterment/` |
