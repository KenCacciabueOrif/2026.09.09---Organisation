...
2. Draft `plan.md` with:
   ...
   - Explicit non-goals
   - Rollback / risk notes
3. Optionally write `plan-mermaid.md` for data/flow diagrams when architecture is non-trivial.
4. If requirements are still ambiguous, list **blocking questions** in `plan.md` and stop — do not guess major product decisions.
