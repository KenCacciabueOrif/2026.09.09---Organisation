...
- **Workstream rotation (post–Cycle 22):** Do **not** default Next FAW to Organisation dashboard polish. Items 20–22 are done for now. Researcher must **justify** workstream vs ROADMAP each cycle; default Next FAW = WorkSpace Continuity X / `#4` approval (when Continuity binds) or research-justified alternative.
